...
data = read.csv("https://raw.githubusercontent.com/RongSong1110/WQD7001/main/Skincare_SurveyInMalaysia_cleandata.csv")
...
ui <- dashboardPage(
  title = "Malaysia App",
  dashboardHeader(title = span("Skincare Survey", style = "font-family: Tahoma, Helvetica, sans-serif; font-weight: bold; font-size: 130%;")),
